...
var analyzer_service_1 = require("./services/analyzer.service");
var communicator_service_1 = require("./services/communicator.service");
var content_checker_service_1 = require("./services/content-checker.service");
// ── Faz 2.5 ──────────────────────────────────────────────────────────────────
var smtp_service_1 = require("./services/smtp.service");
var imap_service_1 = require("./services/imap.service");
var dns_checker_service_1 = require("./services/dns-checker.service");
var warmup_service_1 = require("./services/warmup.service");
var deliverability_tester_service_1 = require("./services/deliverability-tester.service");
...
var WorkerModule = function () {
    ...
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [
                ...
                content_checker_service_1.ContentCheckerService,
                // ── Faz 2.5 ─────────────────────────────────────────────────────────────
                smtp_service_1.SmtpService,
                imap_service_1.ImapService,
                dns_checker_service_1.DnsCheckerService,
                warmup_service_1.WarmupService,
                deliverability_tester_service_1.DeliverabilityTesterService,
                // ── Processors ─────────────────────────────────────────────────────────
