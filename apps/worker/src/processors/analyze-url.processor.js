...
var AnalyzeUrlProcessor = function () {
    ...
    var AnalyzeUrlProcessor = _classThis = /** @class */ (function () {
        function AnalyzeUrlProcessor_1(db) {
        ...
        AnalyzeUrlProcessor_1.prototype.handle = function (job) {
            return __awaiter(this, void 0, void 0, function () {
                var startTime, _a, projectId, websiteUrl, error_1, err;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            startTime = Date.now();
                            _a = job.data, projectId = _a.projectId, websiteUrl = _a.websiteUrl;
                            this.logger.log("[analyze-url] Starting job ".concat(job.id, " \u2014 project: ").concat(projectId, ", url: ").concat(websiteUrl));
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 5]);
                            // ─────────────────────────────────────────────────────────────────────
                            ...
                            // ─────────────────────────────────────────────────────────────────────
                            this.logger.log("[analyze-url] Job ".concat(job.id, " completed (placeholder)"));
                        ...
                        case 4:
                            _b.sent();
                            throw error_1; // BullMQ retry mekanizması devreye girsin
