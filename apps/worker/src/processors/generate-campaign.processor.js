...
var GenerateCampaignProcessor = function () {
    ...
    var GenerateCampaignProcessor = _classThis = /** @class */ (function () {
        function GenerateCampaignProcessor_1(db) {
        ...
        GenerateCampaignProcessor_1.prototype.handle = function (job) {
            return __awaiter(this, void 0, void 0, function () {
                var startTime, _a, projectId, campaignId, error_1, err;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            startTime = Date.now();
                            _a = job.data, projectId = _a.projectId, campaignId = _a.campaignId;
                            this.logger.log("[generate-campaign] Starting job ".concat(job.id, " \u2014 campaign: ").concat(campaignId));
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 5]);
                            // ─────────────────────────────────────────────────────────────────────
                            ...
                            // ─────────────────────────────────────────────────────────────────────
                            this.logger.log("[generate-campaign] Job ".concat(job.id, " completed (placeholder)"));
                            return [4 /*yield*/, (0, database_module_1.logExecution)({
                                    ...
                                    outputPayload: { status: 'placeholder', campaignId: campaignId },
                                    status: 'success',
