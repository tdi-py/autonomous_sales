...
var WarmupExecuteProcessor = function () {
    ...
    var WarmupExecuteProcessor = _classThis = /** @class */ (function () {
        function WarmupExecuteProcessor_1(db) {
        ...
        WarmupExecuteProcessor_1.prototype.handle = function (job) {
            return __awaiter(this, void 0, void 0, function () {
                var startTime, _a, projectId, emailAccountId, error_1, err;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            // ─────────────────────────────────────────────────────────────────────
                            this.logger.log("[warmup-execute] Job ".concat(job.id, " completed (placeholder)"));
                            return [4 /*yield*/, (0, database_module_1.logExecution)({
                                    ...
                                    outputPayload: { status: 'placeholder', emailAccountId: emailAccountId },
                                    status: 'success',
