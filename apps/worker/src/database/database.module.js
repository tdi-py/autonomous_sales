...
exports.DatabaseModule = exports.logExecution = exports.DATABASE_TOKEN = void 0;
var common_1 = require("@nestjs/common");
var postgres_js_1 = require("drizzle-orm/postgres-js");
var postgres_1 = require("postgres");
var schema = require("@autonomous-sales/database");
exports.DATABASE_TOKEN = 'DATABASE';
            ...
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, params.db
                            ...
                            outputPayload: (_a = params.outputPayload) !== null && _a !== void 0 ? _a : {},
                            status: params.status,
                            tokensUsed: (_b = params.tokensUsed) !== null && _b !== void 0 ? _b : 0,
                            modelUsed: params.modelUsed,
                            durationMs: (_c = params.durationMs) !== null && _c !== void 0 ? _c : 0,
                ...
                case 2:
                    ...
                    console.error('[logExecution] Failed to write execution log:', err_1);
                    return [3 /*break*/, 3];
            ...
            providers: [
                {
                    ...
                    useFactory: function () {
                        ...
                        var client = (0, postgres_1.default)(connectionString, { prepare: false });
