...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.getWorkspaces = function (req) {
    ...
    (function () {
        ...
        _getMe_decorators = [(0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({ summary: 'Get current user profile' })];
        _updateMe_decorators = [(0, common_1.Patch)('me'), (0, swagger_1.ApiOperation)({ summary: 'Update current user profile' })];
        _getWorkspaces_decorators = [(0, common_1.Get)('me/workspaces'), (0, swagger_1.ApiOperation)({ summary: 'List workspaces the current user belongs to' })];
        ...
        __esDecorate(_classThis, null, _getWorkspaces_decorators, { kind: "method", name: "getWorkspaces", static: false, private: false, access: { has: function (obj) { return "getWorkspaces" in obj; }, get: function (obj) { return obj.getWorkspaces; } }, metadata: _metadata }, null, _instanceExtraInitializers);
