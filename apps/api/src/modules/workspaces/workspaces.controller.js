...
var WorkspacesController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Workspaces'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('workspaces')];
    ...
    var WorkspacesController = _classThis = /** @class */ (function () {
        function WorkspacesController_1(workspacesService) {
            this.workspacesService = (__runInitializers(this, _instanceExtraInitializers), workspacesService);
        }
        WorkspacesController_1.prototype.create = function (req, dto) {
        ...
        WorkspacesController_1.prototype.findOne = function (id, req) {
            return this.workspacesService.findOne(id, req.user.userId);
        };
        WorkspacesController_1.prototype.update = function (id, req, dto) {
            return this.workspacesService.update(id, req.user.userId, dto);
        };
        WorkspacesController_1.prototype.remove = function (id, req) {
            return this.workspacesService.remove(id, req.user.userId);
        };
        WorkspacesController_1.prototype.invite = function (id, req, dto) {
            return this.workspacesService.invite(id, req.user.userId, dto);
        };
        WorkspacesController_1.prototype.getMembers = function (id, req) {
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({ summary: 'Create a new workspace' })];
        _findAll_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'List all workspaces for current user' })];
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Get a single workspace' })];
        _update_decorators = [(0, common_1.Patch)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Update workspace (admin/owner only)' })];
        _remove_decorators = [(0, common_1.Delete)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Delete workspace (owner only)' })];
        _invite_decorators = [(0, common_1.Post)(':id/invite'), (0, swagger_1.ApiOperation)({ summary: 'Invite a user to workspace (admin/owner only)' })];
        _getMembers_decorators = [(0, common_1.Get)(':id/members'), (0, swagger_1.ApiOperation)({ summary: 'List workspace members' })];
