...
exports.UpdateCallScriptDto = exports.CreateCallScriptDto = exports.UpdateEmailSequenceDto = exports.CreateEmailSequenceDto = exports.UpdateCampaignDto = exports.CreateCampaignDto = void 0;
...
var CreateCampaignDto = function () {
    ...
    var _additionalNotes_decorators;
    var _additionalNotes_initializers = [];
    var _additionalNotes_extraInitializers = [];
    var _scriptOnly_decorators;
    var _scriptOnly_initializers = [];
    var _scriptOnly_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreateCampaignDto() {
                ...
                this.icpProfileId = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _icpProfileId_initializers, void 0));
                this.targetLanguage = (__runInitializers(this, _icpProfileId_extraInitializers), __runInitializers(this, _targetLanguage_initializers, void 0));
                this.additionalNotes = (__runInitializers(this, _targetLanguage_extraInitializers), __runInitializers(this, _additionalNotes_initializers, void 0));
                this.scriptOnly = (__runInitializers(this, _additionalNotes_extraInitializers), __runInitializers(this, _scriptOnly_initializers, void 0));
                __runInitializers(this, _scriptOnly_extraInitializers);
            }
        ...
        (function () {
            ...
            _icpProfileId_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'icp-uuid-here' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _targetLanguage_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'en', enum: ['en', 'tr', 'es', 'de', 'fr', 'pt'] }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['en', 'tr', 'es', 'de', 'fr', 'pt'])];
            _additionalNotes_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'Florist niche\'ine odaklan' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(1000)];
            _scriptOnly_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: false, description: 'Sadece senaryo üret, AI arama yapma' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsBoolean)()];
            ...
            __esDecorate(null, null, _additionalNotes_decorators, { kind: "field", name: "additionalNotes", static: false, private: false, access: { has: function (obj) { return "additionalNotes" in obj; }, get: function (obj) { return obj.additionalNotes; }, set: function (obj, value) { obj.additionalNotes = value; } }, metadata: _metadata }, _additionalNotes_initializers, _additionalNotes_extraInitializers);
            __esDecorate(null, null, _scriptOnly_decorators, { kind: "field", name: "scriptOnly", static: false, private: false, access: { has: function (obj) { return "scriptOnly" in obj; }, get: function (obj) { return obj.scriptOnly; }, set: function (obj, value) { obj.scriptOnly = value; } }, metadata: _metadata }, _scriptOnly_initializers, _scriptOnly_extraInitializers);
...
var CreateEmailSequenceDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _variantLabel_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'A' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
...
var UpdateEmailSequenceDto = function () {
    var _a;
    var _subjectTemplate_decorators;
    var _subjectTemplate_initializers = [];
    var _subjectTemplate_extraInitializers = [];
    ...
    var _bodyTemplate_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UpdateEmailSequenceDto() {
                this.subjectTemplate = __runInitializers(this, _subjectTemplate_initializers, void 0);
                this.bodyTemplate = (__runInitializers(this, _subjectTemplate_extraInitializers), __runInitializers(this, _bodyTemplate_initializers, void 0));
                __runInitializers(this, _bodyTemplate_extraInitializers);
            }
            return UpdateEmailSequenceDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _subjectTemplate_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(1)];
            _bodyTemplate_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(1)];
            __esDecorate(null, null, _subjectTemplate_decorators, { kind: "field", name: "subjectTemplate", static: false, private: false, access: { has: function (obj) { return "subjectTemplate" in obj; }, get: function (obj) { return obj.subjectTemplate; }, set: function (obj, value) { obj.subjectTemplate = value; } }, metadata: _metadata }, _subjectTemplate_initializers, _subjectTemplate_extraInitializers);
            __esDecorate(null, null, _bodyTemplate_decorators, { kind: "field", name: "bodyTemplate", static: false, private: false, access: { has: function (obj) { return "bodyTemplate" in obj; }, get: function (obj) { return obj.bodyTemplate; }, set: function (obj, value) { obj.bodyTemplate = value; } }, metadata: _metadata }, _bodyTemplate_initializers, _bodyTemplate_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
...
exports.UpdateEmailSequenceDto = UpdateEmailSequenceDto;
var CreateCallScriptDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _openingScript_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
...
var UpdateCallScriptDto = function () {
    var _a;
    var _openingScript_decorators;
    var _openingScript_initializers = [];
    var _openingScript_extraInitializers = [];
    ...
    var _closingScript_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UpdateCallScriptDto() {
                this.openingScript = __runInitializers(this, _openingScript_initializers, void 0);
                this.dialogueTree = (__runInitializers(this, _openingScript_extraInitializers), __runInitializers(this, _dialogueTree_initializers, void 0));
                this.objectionHandlers = (__runInitializers(this, _dialogueTree_extraInitializers), __runInitializers(this, _objectionHandlers_initializers, void 0));
                this.closingScript = (__runInitializers(this, _objectionHandlers_extraInitializers), __runInitializers(this, _closingScript_initializers, void 0));
                __runInitializers(this, _closingScript_extraInitializers);
            }
            return UpdateCallScriptDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _openingScript_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
...
exports.UpdateCallScriptDto = UpdateCallScriptDto;
