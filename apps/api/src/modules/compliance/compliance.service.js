...
var ComplianceService = function () {
    ...
    var ComplianceService = _classThis = /** @class */ (function () {
        function ComplianceService_1(db) {
            this.db = db;
        }
        ComplianceService_1.prototype.getRules = function (countryCode, stateCode) {
            return __awaiter(this, void 0, void 0, function () {
                var conditions;
                return __generator(this, function (_a) {
                    conditions = [(0, drizzle_orm_1.eq)(schema.complianceRules.countryCode, countryCode.toUpperCase())];
                    if (stateCode) {
                        conditions.push((0, drizzle_orm_1.eq)(schema.complianceRules.stateCode, stateCode.toUpperCase()));
                    }
                    return [2 /*return*/, this.db.query.complianceRules.findMany({
                            where: drizzle_orm_1.and.apply(void 0, conditions),
                        })];
                });
            });
        };
        ComplianceService_1.prototype.getPhoneClassification = function (leadId) {
            return __awaiter(this, void 0, void 0, function () {
                var verification;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.db.query.phoneVerification.findFirst({
        ...
        ComplianceService_1.prototype.checkCompliance = function (outreachEventId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, {
