...
var ProjectsController = function () {
    ...
    var _confirmAnalysis_decorators;
    var _retryAnalysis_decorators;
    var _getIcpProfiles_decorators;
    var _createIcpProfile_decorators;
    var _updateIcpProfile_decorators;
    var _deleteIcpProfile_decorators;
    var ProjectsController = _classThis = /** @class */ (function () {
        ...
        ProjectsController_1.prototype.confirmAnalysis = function (id, req, dto) {
            return this.projectsService.confirmAnalysis(id, req.user.userId, dto);
        };
        ProjectsController_1.prototype.retryAnalysis = function (id, req) {
        ...
        ProjectsController_1.prototype.updateIcpProfile = function (id, icpId, req, dto) {
            return this.projectsService.updateIcpProfile(id, icpId, req.user.userId, dto);
        };
        ProjectsController_1.prototype.deleteIcpProfile = function (id, icpId, req) {
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({ summary: 'Create a new project — triggers analyze-url job if websiteUrl provided' })];
        ...
        _getAnalysis_decorators = [(0, common_1.Get)(':id/analysis'), (0, swagger_1.ApiOperation)({ summary: 'Get AI analysis for a project. Returns { status: pending } if not done.' })];
        _confirmAnalysis_decorators = [(0, common_1.Patch)(':id/analysis/confirm'), (0, swagger_1.ApiOperation)({ summary: 'Confirm (and optionally edit) analysis results. Marks project active.' })];
        _retryAnalysis_decorators = [(0, common_1.Post)(':id/analysis/retry'), (0, swagger_1.ApiOperation)({ summary: 'Re-trigger URL analysis for a project' })];
        _getIcpProfiles_decorators = [(0, common_1.Get)(':id/icp-profiles'), (0, swagger_1.ApiOperation)({ summary: 'List active ICP profiles for a project' })];
        ...
        _updateIcpProfile_decorators = [(0, common_1.Patch)(':id/icp-profiles/:icpId'), (0, swagger_1.ApiOperation)({ summary: 'Update an ICP profile' })];
        _deleteIcpProfile_decorators = [(0, common_1.Delete)(':id/icp-profiles/:icpId'), (0, swagger_1.ApiOperation)({ summary: 'Soft-delete an ICP profile (sets isActive=false)' })];
        ...
        __esDecorate(_classThis, null, _confirmAnalysis_decorators, { kind: "method", name: "confirmAnalysis", static: false, private: false, access: { has: function (obj) { return "confirmAnalysis" in obj; }, get: function (obj) { return obj.confirmAnalysis; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _retryAnalysis_decorators, { kind: "method", name: "retryAnalysis", static: false, private: false, access: { has: function (obj) { return "retryAnalysis" in obj; }, get: function (obj) { return obj.retryAnalysis; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        __esDecorate(_classThis, null, _updateIcpProfile_decorators, { kind: "method", name: "updateIcpProfile", static: false, private: false, access: { has: function (obj) { return "updateIcpProfile" in obj; }, get: function (obj) { return obj.updateIcpProfile; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _deleteIcpProfile_decorators, { kind: "method", name: "deleteIcpProfile", static: false, private: false, access: { has: function (obj) { return "deleteIcpProfile" in obj; }, get: function (obj) { return obj.deleteIcpProfile; } }, metadata: _metadata }, null, _instanceExtraInitializers);
