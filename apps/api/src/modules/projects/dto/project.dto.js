...
exports.CreateIcpProfileDto = exports.UpdateProjectDto = exports.CreateProjectDto = void 0;
...
var CreateProjectDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _industry_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'ecommerce' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _businessType_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    example: 'saas',
                    enum: ['saas', 'ecommerce', 'agency', 'service', 'marketplace', 'other'],
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['saas', 'ecommerce', 'agency', 'service', 'marketplace', 'other'])];
            _targetGeography_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: ['US', 'CA'], type: [String] }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)()];
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({
                ...
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['onboarding', 'active', 'paused', 'archived'])];
...
var CreateIcpProfileDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _jobTitles_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: ['CTO', 'VP Engineering'], type: [String] }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)()];
