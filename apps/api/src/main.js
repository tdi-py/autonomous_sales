...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, document_1, port;
        var _a, _b, _c;
            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    if (process.env.NODE_ENV !== 'production') {
                        ...
                        console.log("\uD83D\uDCDA Swagger docs: http://localhost:".concat((_b = process.env.PORT) !== null && _b !== void 0 ? _b : 3001, "/api/docs"));
                    }
                    port = (_c = process.env.PORT) !== null && _c !== void 0 ? _c : 3001;
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _d.sent();
                    console.log("\uD83D\uDE80 API running on http://localhost:".concat(port, "/api"));
                    return [2 /*return*/];
            }
        });
    });
